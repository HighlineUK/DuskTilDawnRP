Locales['en'] = {
  ...
  ['service_in_announce'] = 'Officer ~y~%s~s~ has entered service!',
  ['service_out'] = 'you have left service.',
  ['service_out_announce'] = 'Officer ~y~%s~s~ has left their service.',
  -- Action Menu
  ...
  ['out_the_vehicle'] = 'drag from vehicle',
  ['fine'] = 'fine',
  ...
  ['no_players_nearby'] = 'there are no Citizens nearby!',
  ['jail'] = 'Jail',
  ['jail_menu_info'] = 'Jail in Minutes',
