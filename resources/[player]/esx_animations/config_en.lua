...
Config.Animations = {
...

	{
		...
		items = {
			...
			{label = "1", type = "anim", data = {lib = "mp_ped_interaction", anim = "handshake_guy_a"}},
...

	{
		...
		label = 'Job',
		items = {
			{label = "Suspect : 2", type = "anim", data = {lib = "random@arrests@busted", anim = "idle_c"}},
			{label = "3", type = "scenario", data = {anim = "world_human_stand_fishing"}},
			...
			{label = "Police : 4", type = "scenario", data = {anim = "WORLD_HUMAN_CAR_PARK_ATTENDANT"}},
			...
			{label = "Taxi : 5", type = "anim", data = {lib = "oddjobs@taxi@cyi", anim = "std_hand_off_ps_passenger"}},
			{label = "Grocer : 6", type = "anim", data = {lib = "mp_am_hold_up", anim = "purchase_beerbox_shopkeeper"}},
			...
			{label = "All Trades : Hammer", type = "scenario", data = {anim = "WORLD_HUMAN_HAMMERING"}},
			{label = "Tramp : 7", type = "scenario", data = {anim = "WORLD_HUMAN_BUM_FREEWAY"}},
...

	{
		...
		items = {
			...
			{label = "8", type = "anim", data = {lib = "anim@am_hold_up@male", anim = "shoplift_high"}},
			...
			{label = "9", type = "anim", data = {lib = "mp_player_int_upperfinger", anim = "mp_player_int_finger_01_enter"}},
...

	{
		...
		items = {
			...
			{label = "10", type = "attitude", data = {lib = "move_m@money", anim = "move_m@money"}},
